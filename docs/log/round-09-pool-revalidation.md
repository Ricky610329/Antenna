...
- **狀態**: archived（**162/162 全收**，2026-07-06 補畢）
...
```
- 事件: 2026-07-05 晚發車（無人值守 ~10hr）；~3.4 分/筆；3 筆 COM error → **2026-07-06 重跑同指令補收,
  162/162 全收**（n10 漂移 −0.24 落校正帶、e10/e32 為 E 臂中段值——無新紀錄、結論不動）。
