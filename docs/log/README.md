...
| 17 | 帶外主目標一批：低側裙擺攻堅（手術+分組/尺寸+公證） | 🔵 running（2026-07-09@37） | — | [round-17](round-17-oob-primary.md) |
| 18 | 帶外二批：挖礦落地（舊藏公證 b20/vb43+低側家族救援+c18 手術） | 🟡 proposed（待發@218） | — | [round-18](round-18-oob-mining.md) |
