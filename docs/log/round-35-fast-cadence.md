...
| 批 | 狀態 |
|---|---|
| 1（r35b1{a-c}） | 🔵 2026-07-22 15:42 發車（v51 輕量首航〔~60 分 vs 全訓 80-110;凍結 1.36=+0.15 ⚠超審計線,待 v52 全訓對照判〕;asym 記錄鍵首航;候選池結構 60%;查重 0×3。tier 0:c1d3 收鏈〔8.95 局部頂,75/624 已測〕→ **c1d4 expert 試點首航**〔同錨+專家排序掃殘餘 549;判準=連兩包專家半勝〕;c2rad 十步 rad −0.49） |
