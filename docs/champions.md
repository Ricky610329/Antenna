# 冠軍名鑑（certified；最後更新 2026-07-11 晨，R20 收檔＝margin 王 r2_016 +0.39（c18 王朝三連代））
...
| 頭銜 | id | 數字 | 判準依據 |
|---|---|---|---|
| 👑 **margin 王** | **a024** | **wm +0.35**／rad +0.12（公證 3/3;oob 10.72） | 字典序 best（R16 addmap 出土,R17 公證） |
| 🏭 **製造首選** | **x00** | wm +0.19／rad +0.19（**缺陷存活 13/18＝72%**） | margin 相近時穩健性優先（R12 bakeoff） |
| 📡 **rad 王** | **cc_c25_r6s2_r9s2** | **rad +0.62**（wm +0.06,三標;公證 2/2） | R17 雙中央塊出土,R19 公證易主（前任 a15_k4 +0.56） |
