...
- **設計語言**：下主件（匹配底座，尺寸鎖定 235-250px）＋雙翼（帶內引擎 ~6dB，刀鋒敏感 73-83px）＋小塊
  （rad/選擇性旋鈕，甜蜜點 4-6 塊）。
  ★ 修正（2026-08-06,analysis-11 ①②）：尺寸帶=w17 世系**凍結基因**非最優規範（CV 1.8%/3.3% 無變異
  不可檢定；現任王 c48nq1p05_16 的 233/71/28 三項全在帶外=**第二設計語言**）；甜蜜點修訂為
  CLEAN 族內 n8=7（n8=8 斷崖）、王世系另在 n8=3——塊數一律以 **8-連通**計（對角=真連接,R54）。
- **三標張力載體＝翼**：翼買帶內、付 rad＋帶外（消融＋理論模板 0 翼端點連成完整曲線）。
  ★ 補（2026-08-06,analysis-11 ④）：CLEAN 主幹存活；例外=DUST 族反號、王系窄翼群（b2 60-73）三標全贏。
- **w17 家族特殊性**（R12）：非 w17 池家族深掘全敗——24k 池內唯一可製造達標區。
- 尺寸分布：不均度對三標全面有害；金屬分給翼勝過堆主件（analysis-02，相關性級）。
  ★ 推翻（2026-08-06,analysis-11 ③）：不均度效應=跨族 Simpson 假象，分族＋控金屬量後 |ρ|≤0.13
  無穩定獨立效應——不再當選批懲罰項。
