# 冠軍名鑑（certified；最後更新 2026-07-09 晚，R17/R18 收檔＝帶外戰役定案）
...
| 🌊 帶外王（三標內） | c18_sm | **oob 9.04**（wm +0.07/rad +0.32;跨店雙響應公證） | 帶外地板 ≈9.0 的持旗者（R17/R18 定案） |
...
| 2 | i02 | +0.29 | +0.21 | 6 | R15 知情臂＝c25＋中央塊 8px（前任） |
...
（互異三標過解累計 180+；上表僅列公證過的代表。R17 另有三筆**單次**紀錄級待公證:
cc_c25_r6s2_r9s3 wm +0.36（rad −0.22 未過）、cc_x00_r5s2_r8s3 +0.21/oob 9.82、cc_c25_r6s2_r9s2 rad +0.62/wm +0.06。）

### 帶外榜（三標內,oob_bad 升冪;R17/R18 帶外戰役定案:地板 ≈9.0）
| # | id | oob | wm | rad | 公證 |
|---|---|---|---|---|---|
| 1 | c18_sm | **9.04** | +0.07 | +0.32 | 跨店雙響應 ✓ |
