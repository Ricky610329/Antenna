...
> =rad 保單。**穩健王仍是 c21**（局部缺陷存活 crown+tol 合計 11/22=50%,遠勝 a15 系 2/18=11%）——
> 送製造首選看穩健性不看 margin。**第二山頭裁決（R12 family2）：非 w17 家族 F0/F1/F4/F6 深掘全敗**
...
- **公差掃描已收（R11 tol,2026-07-07）**：整面 erode/dilate 1px 三員全滅（極端應力測試）;
  局部邊緣缺陷（k≤4）存活率=margin 的函數——**c21 10/18、缺陷後 wm 中位全 k 保正（穩健王,量測首選）**;
  a15 2/18、w17 1/18。災難崩個案=缺陷踩中承重邊緣（與承重圖同構）。更厚 margin 攻堅=ref3（進行中）。
