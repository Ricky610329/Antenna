# 冠軍名鑑（certified；最後更新 2026-07-13，R24 收輪＝**可用帶外 m24b2_015 9.0 首破 9.09**＋帶內紀錄 s24b2_006 +0.51）
...
| 頭銜 | id | 數字 | 判準依據 |
|---|---|---|---|
| 👑 **margin 王** | **m23b4_030** | **wm +0.49**／rad +0.12／oob 10.35（公證 3/3;三次全 0.49） | **c18 王朝奪回**:r3_001 子代,純隨機臂（R23b4;+0.08 巨躍;前任 k23b1_021 +0.41 在位 1 日）——證 c18 margin 軸未枯竭〔軸相關枯竭〕 |
...
| 🎯 帶內紀錄 | **s25b1_006_g16** | **wm +0.58**（公證 3/3;三次全 0.58）——rad −0.23 未過＝非三標 | 帶內天花板連四批爬升 0.46→0.49→0.51→**0.58**（R25 S 槽鏈,錨 g16 d16;槽鏈=帶內旋鈕付 rad **穩定機理**;前任 s24b2_006 0.51）——比 margin 王 0.49 高 0.09,rad 修回即換王 |
...
| 🌊🏭 **可用帶外紀錄** | **m24b2_015** | **oob 9.0**（wm +0.15/rad +0.46;公證 3/3） | 可用解（wm≥0.15 buffer∧rad≥0）最低帶外,**首破 k7_038 的 9.09**（R24b2 M 純隨機臂,c18 王朝血 vg0338——樂透命中,非根稅因果〔R24 §4〕） |

## 現任榜（三標全過且公證，按 wm 排序）

| # | id | wm | rad | 組件 | 出身（round） |
|---|---|---|---|---|---|
| 1 | **m23b4_030** | **+0.49** | +0.12 | — | 👑 margin 王:c18 王朝 r3_001 子代,純隨機臂（R23b4;+0.08 巨躍;公證3/3） |
| 2 | k23b1_021 | +0.41 | +0.11 | — | cc_r9s2→g1 填空池→C 冷支臂（R23b1;前任 margin 王,在位 1 日） |
...
| — | **m24b2_015** | **9.0** | **+0.15** | +0.46 | R24 n2 3/3 ✓——🌊🏭 可用帶外紀錄（wm≥0.15 內最低;前任 k7_038 9.09） |
