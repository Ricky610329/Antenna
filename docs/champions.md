...
> **2026-07-09 更新（R15）**：**margin 王換 i02**（c25+8px 中帶雙塊,6 組件;wm +0.29/rad +0.21,公證 3/3,
> 缺陷存活 3/4）——出身=R15 知情臂（組件空間+SM 字典序）。g16 同批轉正（+0.21/+0.49）。
> **帶內紀錄保持者 g14 +0.40**（公證✓;rad −0.39 未過=非三標,rad 救援走 R16 塊歸因）。
> 理論模板（實心矩形）否證新盆地,但帶外 4.1-7.1=史上最淨=「翼買帶內付帶外」的 0 翼端點。
>
