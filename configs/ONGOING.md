...
## 🔜 候選 / 待排
- **圖 4-4 錨點驗證＋改造（學長最佳圖溯源產物）**：原樣公證＋對稱化構造版＋帶外機理對比（~10 筆）;
  觸發=任一機空。溯源細節見 scratch 2026-07-07 晚塊（帳面 wm +0.09/帶外 Gain 抑制勝冠軍/不可製造）。
- **底緣邊緣精修臂（壓帶外機理）**：帶外承重圖定位元凶=主件底緣 → 只翻底緣 1-2px 換選擇性;
  觸發=ref3/wide 收檔後有空機。詳見 scratch 2026-07-07 晚塊。
