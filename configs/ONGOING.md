...
- 🔵 **R41 組測試輪**（[round-41](../docs/log/round-41-group-test.md)）:常態線續（select-r41=r40 配置）+**C 臂組級 A/B 鏈**（c41grp,錨 c6tri8p01_18,--mutator group 70/30,判準=連3包劣關/產合格解常駐）;A/B 臂已預跑;R42 收測試回常態（Ricky 07-25 裁示）。
